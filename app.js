// ─── RUNTIME SEGURO ESTRICTAMENTE LOCAL ───

// 1. Cargamos las variables directamente desde data.js
...
// 2. Intentamos recuperar modificaciones locales
try {
    ...
    console.warn("Ignorando caché local.");
}
